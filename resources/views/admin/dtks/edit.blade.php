                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="alamat" name="alamat"
                                    value="{{ $dtks->alamat }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nik" class="col-sm-4 col-form-label text-right">NIK</label>
                            <div class="col-sm-6">
                                <input type="number" inputmode="numeric" class="form-control" id="nik" name="nik"
                                    maxlength="16" oninput="validateNumberInput(this)" required
                                    onkeypress="return isNumberKey(event)" value="{{ $dtks->nik }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" inputmode="numeric" class="form-control" id="kk" name="kk"
                                    maxlength="16" oninput="validateNumberInput(this)" required
                                    onkeypress="return isNumberKey(event)" value="{{ $dtks->kk }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" inputmode="numeric" class="form-control" id="nomor_kontak"
                                    ...
                                    onkeypress="return isNumber(event)" name="nomor_kontak"
                                    value="{{ $dtks->nomor_kontak }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
